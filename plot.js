...
https://medium.com/@xoor/implementing-charts-that-scale-with-d3-and-canvas-part-2-d9f657f2757b
...
function showData(dataExample){

const margin = { top: 40, right: 15, bottom: 60, left: 70 };
...
svgChart.append('text')
        ...
        .text('Energy Separation (eV)');
svgChart.append('text')
        .attr('x', `${width / 2.5}`)
        .attr('y', `${height + 40}`)
        .text('Nanotube Diameter (\u00C5)');
